		...
		If playerFigure.inRoom.name = "elevator"
			if Building.Elevator.waitAtFloorTimer <= MilliSecs()
				...
				if clickedRoom
					...
					If Building.Elevator.EnterTheElevator(playerFigure) 'das Ziel hier nicht angeben, sonst kommt es zu einer Einsteigepr�fung die den Spieler eventuell wieder rauswirft.
...
'		result.nearbyDistanceRangeTopY = (floorY - position.y - 73) * -1 '73 = Stockwerkh�he
