...
Type TGUIEventKeys
	...
	Field GUIObject_OnTryDropOnTarget:TEventKey = GetEventKey("GUIObject.OnTryDropOnTarget", True)
	Field GUIObject_OnDropOnTarget:TEventKey = GetEventKey("GUIObject.OnDropOnTarget", True)
	Field GUIObject_OnDropOnTargetDeclined:TEventKey = GetEventKey("GUIObject.OnDropOnTargetDeclined", True)
	Field GUIObject_OnDropOnTargetAccepted:TEventKey = GetEventKey("GUIObject.OnDropOnTargetAccepted", True)
	...
	Field GUIObject_OnDrag:TEventKey = GetEventKey("GUIObject.OnDrag", True)
	...
	Field GUIObject_OnDrop:TEventKey = GetEventKey("GUIObject.OnDrop", True)
	...
	Field GUIObject_OnScrollwheel:TEventKey = GetEventKey("GUIObject.OnScrollwheel", True)
