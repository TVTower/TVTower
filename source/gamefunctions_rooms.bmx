...
Type RoomHandler_Boss Extends TRoomHandler
	...
	Method Initialize:Int()
		...
		If Not smokeEmitter
			...
			smokeConfig.AddFloat("velocityMin", 25)
			smokeConfig.AddFloat("velocityMax", 40)
			smokeConfig.AddFloat("lifeMin", 0.3)
			smokeConfig.AddFloat("lifeMax", 2.5)
			smokeConfig.AddFloat("scaleMin", 0.2)
			smokeConfig.AddFloat("scaleMax", 0.3)
			smokeConfig.AddFloat("scaleRate", 1.2)
			smokeConfig.AddFloat("alphaMin", 0.5)
			smokeConfig.AddFloat("alphaMax", 0.8)
			smokeConfig.AddFloat("alphaRate", -0.90)
			smokeConfig.AddFloat("angleMin", 165)
			smokeConfig.AddFloat("angleMax", 195)
			smokeConfig.AddFloat("xRange", 2)
			smokeConfig.AddFloat("yRange", 2)

			Local emitterConfig:TData = New TData
			emitterConfig.Add("area", New TRectangle.Init(44, 335, 0, 0))
			emitterConfig.AddInt("particleLimit", 70)
			emitterConfig.AddFloat("spawnEveryMin", 0.45)
			emitterConfig.AddFloat("spawnEveryMax", 0.70)
