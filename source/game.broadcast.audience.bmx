...
'Diese Klasse repr�sentiert das Publikum, dass die Summe seiner Zielgruppen ist.
...
Type TAudience {_exposeToLua="selected"}
	'Optional: Eine Id zur Identifikation (z.B. PlayerId). Nur bei Bedarf f�llen!
	Field Id:Int
